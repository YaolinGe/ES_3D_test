...
import sys
import pickle
from ExcursionSetsCode.es_strategies import *
...
print(my_path)
# print(os.path.dirname(os.path.abspath("Read_me")))
#%%
...
print(grid_east_diff) # I guess distance in metres
print(grid_north_diff)
print(dist_east)
print(dist_north)
...
graph_mesh_points = np.mgrid[lx:ux:step_x, ly:uy:step_y]
print(graph_mesh_points)
