...
im = imageio.imread('IMG_0953.JPG')
print(im.shape)

import matplotlib as mpl
# mpl._png.read_png('IMG_0953.JPG')

x = np.arange(25)
y = np.arange(25)
x, y = np.meshgrid(x, y)
img = imageio.imread('IMG_0953.JPG')
fig = plt.figure(figsize=(10, 10))
ax = plt.gca(projection = '3d')
ax.plot_surface(x, y, 10*np.ones_like(x), rstride=5, cstride=5, facecolors=img)
plt.show()
